...
export async function loader({ request }) {
    try {
        ...
        if (player.teamId == null) {
            return json({ message: "Please join a team" });
        }
                    ...
                    <>
                        <div className="w-full flex flex-row justify-between items-end">
                            ...
                            <Button
                                ...
                                name="_action"
                                value="leave"
                                className=" whitespace-nowrap mb-4 h-11"
                            />
                        </div>
                        <div className="w-full flex flex-row justify-between items-end">
                            <Field
                            ...
                            <Button
                                ...
                                name="_action"
                                value="delete"
                                className="whitespace-nowrap px-4 mb-4 h-11"
                            />
                        </div>
                        ...
                        <table className="mt-5 table-auto w-full text-black">
                            <tbody>
                                {data.team.players.map(function (
                                    player,
                                    index
                                ) {
                                    return (
